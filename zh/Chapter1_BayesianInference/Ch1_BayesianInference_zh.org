#+TITLE: 用 Python 做贝叶斯建模与计算 — 第1章 贝叶斯推断
#+LANGUAGE: zh-CN
#+OPTIONS: toc:3 num:2
#+STARTUP: showall
...
$$
\underbrace{p(\boldsymbol{\theta} \mid \boldsymbol{Y})}/{\text{后验 posterior}} = \frac{\overbrace{p(\boldsymbol{Y} \mid \boldsymbol{\theta})}^{\text{似然 likelihood}}\; \overbrace{p(\boldsymbol{\theta})}^{\text{先验 prior}}}{\underbrace{{p(\boldsymbol{Y})}}/{\text{边际似然 marginal likelihood}}}
$$
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_006_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_016_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_018_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_026_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_028_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_030_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_032_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_034_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_038_0.png]]
...
#+END_SRC
[[file:Ch1_BayesianInference_zh_files/ch1_040_0.png]]
